...
const section = panel.add_section("Measurements and units", `Change the units of measurement used
    throughout the game`);

IRF.vdom.container.then(async (vcontainer) => {
    ...
    section.add_checkbox("Use metric units", "km_units", async (value) => {
    ...
    section.add_checkbox("Use minutes and seconds for coordinates", "coordinates_fancy");
})