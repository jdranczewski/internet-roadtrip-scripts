...
function toggleMapFullscreen(fullscreen?: boolean) {
    ...
    // TODO revisit when implementing the car marker stuff
    // if (!mapIsFullscreen && changeStopArgs && (vcontainer.data.endTime - Date.now()) > 2000) vcontainer.methods.changeStop(...changeStopArgs);
