...
ml_map.once("load", () => {
    if (ml_map.getSource('sv')) {
        section.add_comment(`<span style='color: #ff3434'>You have another SV coverage extension installed,
    ...
    ml_map.moveLayer("svugc-tiles", ml_map.getLayer("old-route-layer") ? "old-route-layer" : "route");
